...
<head>
    <?php
    // Include koneksi.php to get $baseurl
    include "koneksi.php";
    ?>
    <meta charset="UTF-8">
        ...
        <div class="login-box">
            <form action="auth_login.php" method="post">
                ...
                if (isset($_GET['registration']) && $_GET['registration'] == 'success') {
                    echo '<div class="success-message">Registrasi berhasil! Silakan login dengan akun baru Anda.</div>';
                ...
                <div class="register-link">
                    <p>Belum punya akun? <a href="javascript:void(0);" onclick="window.location.href='register.php';">Daftar sekarang</a></p>
                </div>
            </form>
        </div>
    </div>
